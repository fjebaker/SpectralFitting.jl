...
# composed models
model = DummyMultiplicative(a=0.0, b=1.0) * (DummyAdditive(K=2.0, a=3.0) + DummyAdditive(K=4.0, a=5.0))
out = SpectralFitting.all_parameters_to_named_tuple(model)
@test out == (;K_1 = 4.0, a_1 = 5.0, b_1 = 5.0, K_2 = 2.0, a_2 = 3.0, b_2 = 5.0, a_3 = 0.0, b_3 = 1.0) 